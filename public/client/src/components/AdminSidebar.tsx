  ...
  return (
    <aside className="w-64 min-h-screen bg-gray-900 border-r border-white/10 text-white p-4 flex flex-col">
      ...
      <div className="mt-auto pt-6 border-t border-white/5">
        <button onClick={handleLogout} className="flex items-center gap-3 p-3 w-full text-gray-400 hover:text-red-400 hover:bg-red-400/10 rounded-xl transition-all"  >
